--[[
	compass.lol UI Library — Single-file module.
	Load via require or loadstring:
	
	local Compass = loadstring(game:HttpGet("https://raw.githubusercontent.com/ccursedd/wsp.lat/refs/heads/main/madebymev/ui.lua"))()
